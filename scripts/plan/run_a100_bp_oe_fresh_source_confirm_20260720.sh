...
# Second untouched H5/off40 source.  Excludes the complete 240-state training
# bank, the old 12-state recursive Gate, and the first fresh 60-state Gate.

ROOT=/225010117/code/learn_wm
BUNDLE=/225010117/a100_operator_head_20260720
OUT=/225010117/logs/bp_oe_recursive_a100_20260720/fresh_eval_source_h5_off40_n60_seed20260727_v1
...
FRESH_A=/225010117/logs/bp_oe_recursive_a100_20260720/fresh_eval_source_h5_off40_n60_seed20260726_v1/source.npz
...
"${PY}" "${COLLECTOR}" \
    ...
    "+audit.exclude_sources='${TRAIN},${OLD_EVAL},${FRESH_A}'" \
    +audit.out="${RESULT}" \
    >"${LOG}" 2>&1

touch "${OUT}/ALL.done"
echo "fresh confirm source complete at $(date -Is)"
