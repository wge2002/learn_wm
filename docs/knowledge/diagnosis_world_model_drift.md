...
> 解决方案侧：已证伪的离散尝试（承诺锚点 / 离散算子 / 40k sweep）合并归档于 [discrete_attempts_falsified_archive.md](discrete_attempts_falsified_archive.md)；当前定案的活方向见 [direction_discrete_regime_from_lewm.md](direction_discrete_regime_from_lewm.md)。
> 这些 MD 共享下面第 0 节的实验对象与定义。
