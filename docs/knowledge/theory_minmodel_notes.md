...
1 种子 smoke(3 种子正式版见 minmodel_v2.json):

| K | 每步局部增益 | 乘积 sigma_1(P_8) | 即时动作增益 | 一步 MSE |
| ---: | ---: | ---: | ---: | ---: |
| 1 | 3.24 | 1.74 | 1.40 | 0.122 |
| 3 | 2.88 | 1.21 | 1.35 | 0.125 |
| 5 | 2.20 | 0.83 | 1.51 | 0.156 |
| 10 | 1.85 | 0.84 | 1.50 | 0.198 |

复现 PushT 四签名:每步增益驯化、一步精度代价、即时动作增益不降反微升、
动作回声驯化远弱于误差乘积驯化。
